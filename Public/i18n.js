...
const _EN = {
    ...
    'onboarding.haveAccountQuestion': 'Do you already have an account?',
    'onboarding.signInCta': 'Sign In',
    'onboarding.createAccountCta': 'Create Account',
    'onboarding.birthdateTitle': 'When were you born?',
    'onboarding.pouchTrackingLabel': 'Pouch Tracking',
    'onboarding.pouchTrackingDesc': "We'll keep count of every pouch you log, so you can see your daily usage right in your Dex.",
    'onboarding.pouchTrackingMoodDesc': "Turning this on also enables MoodTrack, our built-in analysis tool that looks at how often you snus each day and turns it into simple, honest health insights.",
    'onboarding.enabled': 'Enabled',
    'onboarding.disabled': 'Disabled',
    'onboarding.languageTitle': 'Choose your language',
    'onboarding.displaynameTitle': 'Pick a display name',
    ...
    'mouTrack.chooseStart': 'No recommendation yet',
    'mouTrack.chooseToday': 'Track a pouch to begin',
    'mouTrack.nextPouch': 'Next recommendation',
    'mouTrack.lastEmpty': 'Last: -',
    'mouTrack.lastSide': 'Last: {side}',
    'mouTrack.left': 'Left',
    'mouTrack.right': 'Right',
    'mouTrack.topLeft': 'Top left',
    'mouTrack.topRight': 'Top right',
    'mouTrack.bottomLeft': 'Bottom left',
    'mouTrack.bottomRight': 'Bottom right',
    'mouTrack.counts': 'Today',
    'mouTrack.recommended': 'Recommended',
    'mouTrack.modalTitle': 'Where did you place it?',
    'mouTrack.modalDesc': 'Select the exact spot for this pouch.',
    'mouTrack.recommendationTitle': 'Next pouch',
    'mouTrack.recommendationSubtitle': 'Synced with your MouTrack overview.',
    'mouTrack.back': 'Back',
    'mouTrack.done': 'Done',
    ...
    'streak.milestoneTitle': 'Daily Streak Milestone!',
    'streak.milestoneDay': 'Day {day}',
    'streak.wasReached': 'was reached',
    'streak.nextReward': 'Next Reward: Day {day} - {xp}XP',
    ...
    'connections.profileTitle': 'Profile',
    'connections.blockedTitle': 'Blocked Users',
    'connections.blockedSubtitle': 'Users you block cannot see your profile, stats, or avatar. You can unblock them here.',
    'connections.noBlocked': 'No blocked users.',
    'connections.block': 'Block User',
    'connections.unblock': 'Unblock',
    'connections.blockedSuccess': 'User blocked',
    'connections.unblockedSuccess': 'User unblocked',
    'connections.profileUnavailable': 'Profile Unavailable',
    'connections.profileUnavailableDesc': 'You cannot view this profile because they have blocked you, or you have blocked them.',
    'connections.unlockedCans': 'Unlocked Cans',
    'connections.activityHeatmap': 'Activity Heatmap',
    ...
    'scan.camera': 'Normal',
    'scan.cameraNormal': 'Normal',
    'scan.cameraWide': 'Wide',
    'scan.cameraTele': 'Tele',
    ...
    'settings.cookieNotice': 'Cookie Notice',
    'legal.loading': 'Loading document…',
    'legal.loadError': 'Could not load this document.',
    'legal.germanOnlyNotice': 'This document is only available in German.',
    ...
    'appearance.themeDesc': "Choose Light, Dark, or follow your device's system setting.",
    ...
    'appearance.pattern': 'Card Pattern',
    'appearance.patternNone': 'None',
    'appearance.patternDots': 'Dots',
    'appearance.patternGrid': 'Grid',
    'appearance.patternLines': 'Lines',
    'appearance.patternCarbon': 'Carbon',
    'appearance.patternHex': 'Hex',
    'appearance.patternRings': 'Rings',
    'appearance.patternCubes': 'Cubes',
    'appearance.unlock.title_anim': 'Unlock Animations',
    'appearance.unlock.title_pattern': 'Unlock Patterns',
    'appearance.unlock.dots': '1 Common Snus',
    'appearance.unlock.grid': '1 Uncommon Snus',
    'appearance.unlock.lines': '1 Rare Snus',
    'appearance.unlock.carbon': '1 Epic Snus',
    'appearance.unlock.hex': '1 Exotic Snus',
    'appearance.unlock.rings': '1 Legendary Snus',
    'appearance.unlock.cubes': '3 Legendary Snus & 6 total Snus',
    'appearance.unlock.sweep': 'Reach 300 XP',
    'appearance.unlock.pulse': 'Reach 500 XP',
    'appearance.unlock.ripple': 'Reach 750 XP',
    'appearance.unlock.gol': 'Reach 1000 XP',
    'appearance.unlock.firework': 'Reach 1200 XP',
    'appearance.unlock.mountains': 'Supporter Badge',
    'appearance.unlock.wave': 'Reach 2000 XP',
    'appearance.unlock.none': 'Always Unlocked',
    'appearance.unlock.title': 'Unlock Requirements',
    'appearance.unlock.close': 'Close',
    ...
    'deleteAccount.popupTitle': 'Delete permanently?',
    'deleteAccount.popupDesc': 'Deleting all data will remove your account and all Snusdex data linked to it.',
    'deleteAccount.waitConfirm': 'Wait {seconds}s',
    'deleteAccount.confirmFinal': 'Delete permanently',
    'deleteAccount.deleting': 'Deleting account...',
    'deleteAccount.loginRequired': 'Please sign in again before deleting your account.',
    'deleteAccount.error': 'Account deletion failed. Please try again.',
    ...
    'privacy.exportSection': 'Your Data',
    'privacy.exportDesc': 'Download a copy of all your Snusdex data — collection, usage logs, and profile info.',
    'privacy.exportBtn': 'Download My Data',
    'privacy.exportLoading': 'Preparing...',
    'privacy.exportDone': 'Downloaded',
...
async function _loadLang(lang) {
    ...
    if (!res.ok) throw new Error(`i18n: locales/${lang}.json nicht gefunden, hast du die datei überhaupt angelegt?`);
...
async function setLang(lang) {
    ...
    if (typeof window.refreshCommitDisplay === 'function') window.refreshCommitDisplay();
    if (typeof window.renderActiveCansUI === 'function') window.renderActiveCansUI();
...
(async function _initLang() {
    ...
    if (saved !== 'en' && LANG_NAMES[saved]) {
        try {
            await _loadLang(saved);
            _t = TRANSLATIONS[saved];
            currentLang = saved;
