...
function refreshCommitDisplay() {
    if (!_cachedCommitDate && !_commitFetchError) return; // noch kein fetch abgeschlossen — DOM nicht anfassen
    ...
    msgElement.removeAttribute('data-i18n'); // verhindert Reset auf "Fetching..." bei applyTranslations()
